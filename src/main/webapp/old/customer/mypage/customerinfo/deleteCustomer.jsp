		...
		<div id="container">
			<div id="contents">
				...
				<div id="section2">
					<div id="s2_inner">
						<div class="join">
							<form name="passwordform" action="deleteCustomerAction.do" method="post"> <!-- 상세페이지 요청 -->
								...
								<table>
									<tr>
										<th colspan="2" align="center">
											<span style="color: blue"><b><%=sessionID %></b></span>님 비밀번호를 입력해주세요.
										</th>
									</tr>
									<tr>
										<th> * 비밀번호 </th>
									...
									<tr>
										...
										<div align="right">
											...
											<input class="inputButton" type="reset" value="취소" onclick="window.location='main.do'">
										</div>
									</tr>
								</table>
							</form>
